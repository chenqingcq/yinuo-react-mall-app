...
class List extends React.Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: "广告位期限",
        dataIndex: "adValidity",
        key: "adValidity",
        render : adValidity => {
            return Utils.formatDate(adValidity, "YYYY-MM-DD hh:ii");
        }
      },
      {
        title: "实付金额",
        ...
        key: "goodsAmount",
        render : gondsAmount => {
            return <span className='bule'>{`¥${gondsAmount}`}</span>
        }
      },
      {
        title: "支付方式",
...
const OrderAdList = Form.create()(List);
export default OrderAdList;
