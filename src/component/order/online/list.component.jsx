...
class List extends React.Component {
  ...
  handleSearch = e => {
    e.preventDefault();
    this.props.form.validateFields(['phone','type','status','date'],(err, values) => {
  ...
  handleDeliverSubmit = () => {
    let _this = this,
      { match } = this.props,
      id = match.params.id;
    this.props.form.validateFields(['waybillNo'],(err, values) => {
      if (!err) {
        values.orderIds = this.state.isDispleyList;
      ...
      <div id="wrap">
        ...
        <div className="content tableList">
          ...
          <div style={{ marginBottom: 15 }}>
            <Button disabled={this.state.selectedRowKeys.length === 0} onClick={this.onClickDeliverBtn.bind(this)}>批量发货</Button>
          </div>
          <div style={{ marginBottom: 15 }}>
...
const OrderOnlineList = Form.create()(List);
